...
\centerline{
\hpic{\includegraphics[scale=0.3]{analysis/res/SelectDevice}}
}
...
\centerline{
\hpic{\includegraphics[scale=0.3]{analysis/res/ShowStatusThermostat}}
\hpic{\includegraphics[scale=0.3]{analysis/res/ShowStatusInduction}}
}
...
\parpic{\includegraphics[scale=0.4]{analysis/res/flxaccess}}
...
\piccaption{FLX Access}
\parpic{\includegraphics[scale=0.25]{analysis/res/flxdltool}}
