...
\label{sec:Systemtest Spezifikation}
...
\textbf{Anforderung}& \textbf{abgedeckt durch}\\ \hline
Use Case A & ST1: Küche initialisieren \newline ST2: Küche anpassen \newline ST3: Küche löschen \\ \hline
Use Case B & ST4: Protokoll auslesen \\ \hline
Use Case B2 & ST5: Geräteparameter ändern \newline ST6: Geräteparameter ändern mit Validierung \\ \hline
Use Case C & ST7: Kritische Geräteparameter ändern \\ \hline
Use Case C & ST7: Kritische Geräteparameter ändern \\ \hline
\ac{FR}1 & ST8: Kennwortschutz \newline ST9: Kennwortschutz mit falschem Kennwort \\ \hline
\ac{FR}2 & ST10: Suchlauf mit Gruppierung \\ \hline
\ac{FR} & ST11: Austausch von Küchenlayouts \\ \hline
\ac{NFR} & ST12: Küche mit grosser Anzahl Geräte (50) \\ \hline
\ac{NFR} & ST13: Küche mit grosser Anzahl Geräte (150) \\ \hline
\ac{NFR} & ST14: Bluetooth Unterstützung \\ 
\end{tabularx}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{r X }
\textbf{Testziel} & Erfüllen von \ac{NFR}. Die Applikation soll zwischen 30-50 Fluxron Geräte problemlos verwalten können. \\
\textbf{Vorbedingungen} & Die Applikation ist gestartet und es können via Suchlauf beliebig viele simulierte Geräte gefunden werden.\\
\textbf{Durchführung} & \begin{enumerate}
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{r X }
\textbf{Testziel} & Erfüllen von \ac{NFR}. Die Applikation soll mit Einschränkungen bis zu 150 Fluxron Geräte verwalten können.\\
\textbf{Vorbedingungen} & Die Applikation ist gestartet und es können via Suchlauf beliebig viele simulierte Geräte gefunden werden.\\
\textbf{Durchführung} & \begin{enumerate}
\item Eine neue Küche initialisieren
...
\begin{table}[H]
\begin{tabularx}{\textwidth}{r X }
\textbf{Testziel} & Erfüllen von \ac{NFR}. Die Applikation kann sowohl mit Bluetooth Classic als auch Bluetooth 4.0 Geräten kommunizieren. \\
\textbf{Vorbedingungen} & \begin{itemize}
